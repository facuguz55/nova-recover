...
import { sanitizeString, sanitizeHtml, isValidUUID } from "@/lib/sanitize";
...
export async function POST(req: Request) {
  ...
  // Verificar autenticación: sesión de usuario O secret interno
  const authHeader = req.headers.get("x-internal-secret");
  if (authHeader && INTERNAL_SECRET && authHeader === INTERNAL_SECRET) {
    // Llamada interna desde stripe webhook — leer user_id del body
    ...
    // Llamada desde el cliente autenticado
